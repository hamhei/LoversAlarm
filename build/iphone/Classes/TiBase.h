...
// in simulator we redefine to format for LoversClock Developer console
...
{\
	NSString * exceptionName = [@"org.loversclock." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.loversclock";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILoversClockNativeItemNone = -1, 
	UILoversClockNativeItemSpinner = -2,
	UILoversClockNativeItemProgressBar = -3,
	
	UILoversClockNativeItemSlider = -4,
	UILoversClockNativeItemSwitch = -5,
	UILoversClockNativeItemMultiButton = -6,
	UILoversClockNativeItemSegmented = -7,
	
	UILoversClockNativeItemTextView = -8,
	UILoversClockNativeItemTextField = -9,
	UILoversClockNativeItemSearchBar = -10,
	
	UILoversClockNativeItemPicker = -11,
	UILoversClockNativeItemDatePicker = -12,
	
	UILoversClockNativeItemInfoLight = -13,
	UILoversClockNativeItemInfoDark = -14,
	
	UILoversClockNativeItemDisclosure = -15,
	
	UILoversClockNativeItemContactAdd = -16
};
