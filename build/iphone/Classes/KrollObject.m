...
//@interface LoversClockObject : NSObject
//@end

@interface LoversClockObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LoversClockObject class]])
		{
			for (NSString *key in [[(LoversClockObject*)o modules] allKeys])
			{
